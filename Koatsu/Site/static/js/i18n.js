...
const I18n = {
    ...
    translations: {
        en: {
            ...
            'services.why.network.desc': 'Extensive partnerships across Asia, Europe, and beyond for seamless sourcing.',
        ...
        ja: {
            ...
            'services.why.network.desc': 'アジア、ヨーロッパ、その先へのシームレスな調達のための広範なパートナーシップ。',
